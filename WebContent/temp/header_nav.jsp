    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<%= application.getContextPath() %>/notice/notice_BackUp.jsp">Notice</a>
          </li>
          ...
          <li class="nav-item">
			...
			<% } else { %>
			     ...
			     <li class="nav-item">
			<a class="nav-link" href="<%= application.getContextPath() %>/member/memberJoin.jsp">Join </a>
          </li>
          <li class="nav-item">
